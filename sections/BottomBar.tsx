export default function BottomBar() {
    return (
        <div className="flex text-montserrat flex justify-center gap-8 text-slate-200 absolute bottom-0 w-full shadow-lg">
